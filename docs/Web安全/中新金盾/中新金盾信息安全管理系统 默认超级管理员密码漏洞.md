...
![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/1.png)

系统默认管理员账号密码：

`admin/zxsoft1234!@#$`

![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/2.png)

登录页面如上，使用账号密码登录

其中泄露了大部分信息，其中包括 SMMS与FTP 及用户信息

![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/3.png)

![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/4.png)
...
![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/5.png)
...
![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/6.png)

## Goby & POC

`中新金盾信息安全管理系统 默认超级管理员密码漏洞`

![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/7.png)


![](resource/中新金盾信息安全管理系统默认超级管理员密码漏洞/media/8.png)