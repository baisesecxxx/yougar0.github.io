...
![](resource/帆软报表v8.0任意文件读取漏洞CNVD-2018-04757/media/1.png)
...
![](resource/帆软报表v8.0任意文件读取漏洞CNVD-2018-04757/media/2.png)

使用解密脚本解密文件

![](resource/帆软报表v8.0任意文件读取漏洞CNVD-2018-04757/media/3.png)

得到密码，即可登陆后台系统，账户为 admin

![](resource/帆软报表v8.0任意文件读取漏洞CNVD-2018-04757/media/4.png)
...
![](resource/帆软报表v8.0任意文件读取漏洞CNVD-2018-04757/media/5.png)
...
![](resource/帆软报表v8.0任意文件读取漏洞CNVD-2018-04757/media/6.png)